...
const { registerUser, loginUser, getAllUsers, updateUserRole, trackLogin, checkLock, userRole, updateUserProfile, updateUserStatus } = require('../../controllers/userControllers/userControllers');
